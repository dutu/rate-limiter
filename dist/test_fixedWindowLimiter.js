...
describe("Constructor", function () {
  it('should create a new instance', function () {
    var limiter = new _index.FixedWindowLimiter({
      tokensPerInterval: 10,
      interval: 10 * 1000
    });
    expect(limiter).to.be.an.instanceOf(_index.FixedWindowLimiter);
  });
});
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            limiter = new _index.FixedWindowLimiter({
              tokensPerInterval: 10,
              interval: 1000
            });
...
//# sourceMappingURL=test_fixedWindowLimiter.js.map