...
var _index = _interopRequireDefault(require("../dist/index.mjs"));
...
describe("Constructor", function () {
  it('should create a new instance', function () {
    var limiter = new _index["default"]({
      tokensPerInterval: 10,
      interval: 10 * 1000
    });
    expect(limiter).to.be.an.instanceOf(_index["default"]);
  });
});
