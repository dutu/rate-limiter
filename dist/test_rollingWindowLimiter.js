...
describe("Constructor", function () {
  it('should create a new instance', function () {
    var limiter = new _index.RollingWindowLimiter({
      tokensPerInterval: 10,
      interval: 10 * 1000
    });
    expect(limiter).to.be.an.instanceOf(_index.RollingWindowLimiter);
  });
});
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            limiter = new _index.RollingWindowLimiter({
              tokensPerInterval: 10,
              interval: 1000
            });
...
//# sourceMappingURL=test_rollingWindowLimiter.js.map